...
\section{Literature review}
    ...
    \subsection{Early papers}
        ...
        \be
        		G_{MAC_1}  = \operatorname{conv} \cup_{p(x_1)p(x_2)} \{ (R_1,R_2) | \text{ Eqn. \eqref{Gmac1} } \}  \label{region:G_MAC1}
        \ee
        \bea
        ...
        \be
        		G_{MMAC}  = \operatorname{conv} \cup_{\mathbf{p(x_1,x_2)}} \{ (R_1,R_2) | \text{ Eqn. \eqref{Gmmac} } \} 
        \ee
        \bea
        ...
        \be
        		G_{HK}  = \operatorname{conv} \cup_{\mathbf{p(x_1)p(x_2)}} \{ (R_1,R_2) | \text{ Eqn. \eqref{Rcmg} } \} 
        \ee
	\bea
